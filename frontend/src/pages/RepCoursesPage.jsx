...
function CourseForm({ initial, onCancel, onSaved }) {
  ...
  return (
    <AppShell sidebarItems={navItems}>
      ...
      {canManageCourses && showAddForm && (
        <CourseForm onCancel={() => setShowAddForm(false)} onSaved={handleSaved} />
      )}
      {canManageCourses && editingCourse && (
        <CourseForm initial={editingCourse} onCancel={() => setEditingCourse(null)} onSaved={handleSaved} />
      )}
